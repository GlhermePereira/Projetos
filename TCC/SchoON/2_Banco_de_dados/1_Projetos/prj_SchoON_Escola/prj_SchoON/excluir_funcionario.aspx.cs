...
{
    public partial class excluir_funcionari : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            CadastrarFuncionarios.excluir_funcionario(Session["nome_func"].ToString(), Session["emailfunc"].ToString());
