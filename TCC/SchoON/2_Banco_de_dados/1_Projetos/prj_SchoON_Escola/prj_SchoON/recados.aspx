<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="recados.aspx.cs" Inherits="prj_SchoON.index" %>
...
<asp:Literal ID="lit_nome_usuario" runat="server"></asp:Literal>
       ...
       <section class="conteudo">
        <section class="paddingConteudo">
            ...
            <div class="areaTitulo"><span class="titulo">Recados Recebidos</span></div>
            ...
            <div class="filtragemRecados">
                ...
                ontextchanged="txt_nome_remetente_TextChanged"></asp:TextBox>
                                  ...
                                  <div class="fl areaBotaoBuscar">
                                    <asp:Button ID="btn_buscar" class="botaoBuscar" runat="server" Text="Buscar" onclick="btn_buscar_Click" EnableTheming="True"></asp:Button>
                                  </div>
                    ...
                    <asp:Button ID="btn_filtrar" class="botaoBuscar" runat="server" Text="Filtrar" 
                            onclick="btn_filtrar_Click"></asp:Button>
