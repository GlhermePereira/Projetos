...
namespace prj_SchoON.cls
{
    ...
    {
        public List<string> email_funcionario(string cd_turma)
        {
        ...
        public bool enviar_recado(string cod_recado, string email_remetente, string email_destinario, string data_recado, 
            string ds_recado, string cod_aluno, string imagen_recado, string titulo_recado, string recado_respondido,string recado_lido)
        {
            MySqlDataReader dados = null;
            ...
            valores[7, 0] = "vTituloRecado";
            valores[7, 1] = titulo_recado;
            valores[8, 0] = "vRecadoRespondido";
            valores[8, 1] = recado_respondido;
            valores[9, 0] = "vRecadoLido";
            valores[9, 1] = recado_lido;
