...
namespace prj_schoon_pais.cls
{
    public class clsRecadosEnviados:clsBanco
    {
        ...
        public bool Recados_enviados_responsaveis(string EmailFuncionario, string DataRecado)
        {
            MySqlDataReader dados = null;
            ...
            if (!ConsultaPorSP("recado_especifico_enviado_responsavel", valores, ref dados))
            {
                FecharConexao();
                return false;
            }
        ...
        public bool Recado_especifico_enviado_responsaveis(string EmailFuncionario, string DataRecado)
        {
            MySqlDataReader dados = null;
        ...
        public List<string> datas_recados(string nm_email_func)
        {
            ...
            if (!ConsultaPorSP("todos_recados_enviados_responsavel", valores, ref dados))
            {
